...
/*increments the score every time the function is called*/
void update_score(struct Model *modelPtr, UINT16 value) {
	modelPtr->score += value;
}
/*Toggles player move requested value in the model*/
...
/*Getter for the move requested value in the model*/
